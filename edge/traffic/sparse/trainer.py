...
#     from head_detection_demo import read_img
...
#     a = Head_Detector_Trainer(head_detector_vgg16).cuda()
...
#     #         print(scale)
#     #         import torch.onnx
#     #         torch.onnx.export(a, (img,bbox,scale), "./alexnet.proto", verbose=True)
#     #         break
#     #     break
#     img_path = "./6.jpg"
...
#     #     w.add_graph(head_detector_vgg16, dummy_input)
#     import torch
#     # torch.save(a,"./test")
#     print(a.state_dict())
#     print(head_detector_vgg16)
#     print(img)
#     print(a)
#     from pytorch2keras.converter import pytorch_to_keras
#     a.load_state_dict(torch.load("./checkpoints/head_detector_final"))
#     input_var = Variable(torch.FloatTensor(img))
#     # we should specify shape of the input tensor
#     k_model = pytorch_to_keras(head_detector_vgg16, input_var, [(10, 512, 512,)], verbose=True)
